...
uint256 hashGenesisBlock("0x8fc96e42ef9945e85de65e0746b9dbe06093c258e05c7beafff8d673b5cf1900");
...
const string strMessageMagic = "shabi Signed Message:\n";
...
{
    int64 nSubsidy = 195500* COIN;

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // shabi: 1 days
static const int64 nTargetSpacing = 120; // shabi: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal shabi miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "shabi", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x33f0dad90cb3eee76782989edb4ab377a624e5146809eed442914e5221b0e470");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Most of the nation shrouded in smog";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1389526771; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 221209;

        if (fTestNet)
        {
            block.nTime    = 1388980053;
            block.nNonce   = 2586985;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x8040227baa6da94ce8330e4b70f6713fb8a47f9ff939b9c4976a697e14da3ae9"));
